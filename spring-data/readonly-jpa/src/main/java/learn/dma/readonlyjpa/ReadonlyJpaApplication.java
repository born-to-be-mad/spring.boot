...
import learn.dma.readonlyjpa.repo.CourseRepository;
import learn.dma.readonlyjpa.repo.DepartmentRepository;
import learn.dma.readonlyjpa.repo.StaffRepository;
import learn.dma.readonlyjpa.repo.StudentRepository;

@SpringBootApplication
public class ReadonlyJpaApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ReadonlyJpaApplication.class, args);
    }
