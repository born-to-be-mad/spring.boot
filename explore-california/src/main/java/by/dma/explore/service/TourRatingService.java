...
import by.dma.explore.repo.TourRatingRepository;
...
public class TourRatingService {
   ...
   */
  public void createNew(int tourId, Integer customerId, Integer score,
  ...
  public Page<TourRating> lookupRatings(int tourId, Pageable pageable)
    ...
    return tourRatingRepository.findByTourId(
            verifyTour(tourId).getId(), pageable);
  }
   ...
   * @throws NoSuchElementException if no Tour found.
   */
  public TourRating update(int tourId, Integer customerId, Integer score,
                           String comment) throws NoSuchElementException {
   ...
   * @throws NoSuchElementException if no Tour found.
   */
  public TourRating updateSome(int tourId, Integer customerId, Integer score,
                               String comment)
          throws NoSuchElementException {
    TourRating rating = verifyTourRating(tourId, customerId);
    if (score != null) {
  ...
  public Double getAverageScore(int tourId) throws NoSuchElementException {
    List<TourRating> ratings =
            tourRatingRepository.findByTourId(verifyTour(tourId).getId());
