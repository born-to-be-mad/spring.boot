...
var CardListComponent = /** @class */ (function () {
    function CardListComponent(dataService) {
        this.dataService = dataService;
    }
    CardListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.findAll().subscribe(function (data) {
            _this.cards = data;
        });
    };
...
var CardService = /** @class */ (function () {
    ...
    CardService.prototype.findAll = function () {
...
var UserFormComponent = /** @class */ (function () {
    ...
    UserFormComponent.prototype.onSubmit = function () {
        var _this = this;
        this.userService.create(this.user).subscribe(function (result) { return _this.gotoUserList(); });
    };
...
var UserListComponent = /** @class */ (function () {
    ...
    UserListComponent.prototype.deleteUser = function (id) {
        ...
        this.userService.delete(id)
            ...
            _this.userService.findAll().subscribe(function (data) {
                _this.users = data;
            });
        }, function (error) { return console.log(error); });
    };
    UserListComponent.prototype.view = function (id) {
        window.alert(id);
    };
